...
parser.add_argument("--dataset", default='humor', type=str)
parser.add_argument("--dataset-path", default='/usr0/home/yuncheng/MultiBench/data/humor.pkl', type=str)
...
testtimes = []
accs = []
saved_model = '/usr0/home/yuncheng/MultiBench/humor_lf_transformer_1.pt'
for _ in range(1):

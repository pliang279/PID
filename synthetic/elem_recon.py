...
from fusions.common_fusions import ElemMultWithLinear
...
fusion = Sequential2(ElemMultWithLinear(args.hidden_dim, args.hidden_dim), MLP(args.hidden_dim, args.n_latent, args.n_latent//2)).to(device)

...
decoders = [Linear(args.n_latent+args.n_latent//2, input_dim).to(device) for input_dim in input_dims]
...
objective = MFM_objective(2.0, [torch.nn.MSELoss(), torch.nn.MSELoss()], [args.weight, args.weight])

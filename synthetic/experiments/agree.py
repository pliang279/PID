...
def EncourageAgreement(ce_weight=2, agree_weight=args.weight, criterion=torch.nn.CrossEntropyLoss()):
...
objective = EncourageAgreement()

# Training
train(encoders, fusion, head, traindata, validdata, args.epochs, objective=objective, optimtype=torch.optim.AdamW, is_packed=False, lr=args.lr, save=args.saved_model, weight_decay=args.weight_decay, objective_args_dict=dict())

...
fusion = Sequential2(MultiplicativeInteractions2Modal([args.hidden_dim, args.hidden_dim], args.hidden_dim, 'matrix', flatten=True), MLP(args.hidden_dim, args.n_latent, args.n_latent//2)).to(device)
